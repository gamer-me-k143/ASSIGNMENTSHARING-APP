  ...
  (
    ...
    const button = (
      <Comp
        ...
        data-size={size}
        //Crucial change is here:
        data-active={isActive ? "true" : "false"} // Convert boolean to string
...
>(({ asChild = false, size = "md", isActive, className, ...props }, ref) => { // Corrected prop type
  ...
  return (
    <Comp
      ...
      data-active={isActive ? "true" : "false"} // Convert boolean to string
      className={cn(
        "flex h-7 min-w-0 -translate-x-px items-center gap-2 overflow-hidden rounded-md px-2 text-sidebar-foreground outline-none ring-sidebar-ring transition-[width,height,padding]  focus-visible:ring-2 active:bg-sidebar-accent active:text-sidebar-accent-foreground disabled:pointer-events-none disabled:opacity-50 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-[active=true]:bg-sidebar-accent data-[active=true]:text-sidebar-accent-foreground data-[state=open]:hover:bg-sidebar-accent data-[state=open]:hover:text-sidebar-accent-foreground [&>span:last-child]:truncate [&>svg]:size-4 [&>svg]:shrink-0",
        size === "sm" && "text-xs",
        size === "md" && "text-sm",
        "group-data-[collapsible=icon]:hidden",
        className
